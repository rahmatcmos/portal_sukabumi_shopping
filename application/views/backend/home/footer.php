	...
	<script src='<?php echo base_url('asset/backend/js/parsley.min.js'); ?>'></script>
	...
	<script src="<?php echo base_url('asset/backend/js/endless_dashboard.js'); ?>"></script>
	<script src="<?php echo base_url('asset/backend/js/endless_form.js'); ?>"></script>
	<script src="<?php echo base_url('asset/backend/js/endless_wizard.js'); ?>"></script>
	<script src="<?php echo base_url('asset/backend/js/jquery.popupoverlay.js'); ?>"></script>
	<script src="<?php echo base_url('asset/backend/js/jquery.popupoverlay.min.js'); ?>"></script>
